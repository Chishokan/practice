...
const STORY = [
  ...
  //
  // 第1話は「4週目を終えた直後」に出す（week: 3）。
  // 起動直後にいきなり長文を読ませず、まず1ヶ月ぶんプレイして
  // 部の顔ぶれや空気に触れてもらってから、始まりの回想として見せる。
  {
    week: 3,
    variants: [{
      when: () => true,
      ...
      text: () => `陽和(ひより)高校、男子バスケットボール部。
        ...
        「赤星蓮です。ポイントガードやります。——ウィンターカップ、優勝しましょう」
    ...
    variants: [
      {
        ...
        text: () => `あと4週。
          ...
          「ウィンターカップ、優勝しましょう」——あれが今、この部の、全員の目標になっている。
